<template>
    ...
    <main class="flex-1 p-6 sm:p-8 md:p-10">
        <div class="max-w-7xl mx-auto">
            <h2 class="text-2xl font-bold mb-1 text-black dark:!text-white">Saved Properties</h2>
            <p class="text-sm text-black/60 dark:text-white/60 mb-8">Visually organize and manage your favorite
                properties.</p>
            <div class="flex items-center gap-4 mb-8">
                <div class="relative">
                    <select
                        ...
                        <option>Dream Apartments</option>
