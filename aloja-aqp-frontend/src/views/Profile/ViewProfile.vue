        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-10">
                <div>
                    ...
                    <p class="text-sm text-black/60 dark:text-white/60 mb-6">Your personal information and
                        bio.</p>
                ...
                <div>
                    ...
                    <p class="text-sm text-black/60 dark:text-white/60 mb-6">How others can get in touch
                        with you.</p>
                    <div class="divide-y divide-black/10 dark:divide-white/10">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 py-4">
